...
import (
	...
	"github.com/jhondev/golang-swagger/restapi/operations"
	"github.com/jhondev/golang-swagger/restapi/operations/todos"
)

//go:generate swagger generate server --target ..\..\golang-swagger --name ATodoListApplication --spec ..\swagger.yml
